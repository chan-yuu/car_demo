...
# GLobal variable to specify which sensor you want to use
SENSOR = 'camera' # camera or 3d_lidar
...
def generate_launch_description():
  ...
  nav2_params_file = os.path.join(pkg_share, 'config', f'nav2_params_stvl_with_{SENSOR}.yaml')
